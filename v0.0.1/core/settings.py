...
SECRET_KEY = 'django-insecure-$t!d^z=npb#@$xxc2pfy(jybod)1nm)nt)nmevbp(!_^)82n!k'
...
#LOGIN_URL = 'login' # Define a url do login
LOGIN_REDIRECT_URL = '/sala_leitura/'  # Define o redirecionamento após o login
LOGOUT_REDIRECT_URL = '/sala_leitura/login/'  # Define o redirecionamento após o logout